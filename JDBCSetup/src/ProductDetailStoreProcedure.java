...
/**
 * Servlet implementation class ProductDetailStoreProcedure
 */
@WebServlet("/ProductDetailStoreProcedure")
public class ProductDetailStoreProcedure extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductDetailStoreProcedure() {
        super();
